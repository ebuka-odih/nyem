...
class SwipeAndChatTest extends TestCase
{
    ...
    public function test_swipe_creates_match_and_allows_messaging(): void
    {
        ...
        $listingA = Listing::factory()->create(['user_id' => $userA->id, 'city' => 'Lagos', 'type' => Listing::TYPE_MARKETPLACE]);
        $listingB = Listing::factory()->create(['user_id' => $userB->id, 'city' => 'Lagos', 'type' => Listing::TYPE_MARKETPLACE]);

...
export const WelcomePage: React.FC<WelcomePageProps> = ({ onStart, onLogin, onRegister }) => {
  ...
  return (
    ...
    >
      {/* Branding Section */}
      <MotionDiv variants={itemVariants} className="flex flex-col items-center text-center mb-8 w-full">
      ...
      {/* Action Section */}
      <MotionDiv variants={itemVariants} className="w-full max-w-sm space-y-4">
        <button 
          onClick={onStart}
      ...
      {/* Footer Links */}
      <MotionDiv variants={itemVariants} className="mt-8 flex justify-center items-center gap-4 opacity-30 w-full">

...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onGetStarted }) => {
  return (
    <div className="flex flex-col min-h-full bg-brand relative">
      ...
      {/* Bottom Card Section */}
      <div className="bg-white rounded-t-[36px] w-full px-6 md:px-8 pt-10 md:pt-12 pb-10 md:pb-12 flex flex-col items-center shadow-[0_-10px_40px_rgba(0,0,0,0.2)] animate-in slide-in-from-bottom duration-500 shrink-0">
        
        {/* Card Header */}
        <div className="text-center mb-10 md:mb-12">
          <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-3 md:mb-4">Swap. Match. Trade.</h2>
        ...
        {/* Features List */}
        <div className="w-full space-y-7 md:space-y-8 mb-12 md:mb-14">

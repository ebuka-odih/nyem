...
export const SwipeCard: React.FC<SwipeCardProps> = ({ item, onInfoClick }) => {
  ...
  return (
    <>
      <div className="h-[45%] sm:h-[48%] md:h-[52%] bg-gray-100 relative shrink-0">
      ...
      <div className="px-5 pt-5 pb-20 flex flex-col flex-1 bg-white relative overflow-y-auto">
        ...
        <div className="flex items-center pt-2 pb-8 shrink-0">

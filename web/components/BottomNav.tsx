...
export const BottomNav: React.FC<BottomNavProps> = ({ activeTab, onTabChange }) => {
  return (
    <div className="bg-white border-t border-gray-100 pt-3 pb-safe-bottom px-4 flex justify-between items-center z-50 shrink-0 w-full safe-area-bottom absolute bottom-0 left-0 right-0 md:relative md:bottom-auto">
      <button 
